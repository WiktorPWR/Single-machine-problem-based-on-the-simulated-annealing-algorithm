...
const double COOLING_RATE_FAST = 0.91; // Szybsze chłodzenie
const double COOLING_RATE_SLOW = 0.99; // Wolniejsze chłodzenie
...
const double MIN_TEMPERATURE = 1; // Minimalna temperatura, poniżej której kończymy
